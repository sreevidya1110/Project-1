...
output_folders = {
    ...
    'flip_horizontal': r'C:\Sreevidya\VIT\Project-1\augmented_images\flip_horizontal',
    'flip_vertical': r'C:\Sreevidya\VIT\Project-1\augmented_images\flip_vertical',
    'rescale': r'C:\Sreevidya\VIT\Project-1\augmented_images\rescale'
}
...
def augment_image(image_path, save_path, augmentation_type):
    ...
    elif augmentation_type == 'rescale':
        # Rescale augmentation (resize to 50% of the original size)
